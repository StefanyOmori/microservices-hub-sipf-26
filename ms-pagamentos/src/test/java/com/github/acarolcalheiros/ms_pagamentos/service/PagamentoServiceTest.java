package com.github.acarolcalheiros.ms_pagamentos.service;
...
import com.github.acarolcalheiros.ms_pagamentos.exceptions.ResourceNotFoundException;
import com.github.acarolcalheiros.ms_pagamentos.repository.PagamentoRepository;
...
public class PagamentoServiceTest {
    ...
    void updatePagamentoShouldThrowResourceNotFoundExceptionWhenIdDoesNotExists(){
        ...
        Mockito.verify(pagamentoRepository, Mockito.never()).save(any(Pagamento.class));
        Mockito.verifyNoMoreInteractions(pagamentoRepository);
    }
