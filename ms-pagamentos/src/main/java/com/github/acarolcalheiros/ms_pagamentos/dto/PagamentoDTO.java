package com.github.acarolcalheiros.ms_pagamentos.dto;
...
public class PagamentoDTO {
    ...
    @Size(min = 5, max = 5, message = "Campo validade deve ter 5 caracteres")
    private String validade;
    @NotBlank(message = "O campo de segurança é obrigatório")
